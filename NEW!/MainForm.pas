...
{NEW 21.06 --------------------------------------------------------------------}
        ...
        Begin
          ...
          {определ€ю координаты в WGS дл€ выбора точки на модели геоида}
...
begin
 Psz := ComboBox4.ItemIndex -1; /// NEW 25.06
end;
...
begin
  ...
  Except
    MessageDlg('ќшибка пересчета. проверьте настройки',mtError,[mbOk],0);
  end;
  S.Destroy;
  S2.Destroy;
end;
...
begin
  ShowMessage('RouteNav GeoCalculator v. 0.7'+ #13 +
              'by Stanislav O. Shevchuk, 2016-2019'+ #13 +
              'http://aerosurveys.ru');
end;
